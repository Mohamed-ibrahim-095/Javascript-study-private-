بالتأكيد، سأقوم بترجمة ملف الماركداون الذي أرسلته حول بروتوكولات التكرار (Iteration protocols) في JavaScript. سأحرص على أن تكون الترجمة دقيقة ومناسبة للسياق التقني، مع الحفاظ على المصطلحات البرمجية باللغة الإنجليزية إلى جانب شرحها بالعربية لضمان الوضوح والفائدة للمطورين.
...
title: بروتوكولات التكرار (Iteration protocols)
...
- دليل [المُكرِّرات والمولِّدات (Iterators and generators)](/en-US/docs/Web/JavaScript/Guide/Iterators_and_generators)
